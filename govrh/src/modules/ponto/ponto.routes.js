...
router.put('/escalas/:id',                        authorize('ponto', 'update'), auditLog('escalas', 'update'), ctrl.atualizarEscala);
...
// Validação de batida — consultada pelo terminal ANTES de registrar
// Retorna: escala do dia, tipo da próxima batida, aviso se fora do limiar
router.post('/validar-batida',                    authorize('ponto', 'create'), ctrl.validarBatida);
